...
const schema = object({
  ...
  identification: string().matches(/^[0-9]+$/, 'Deben ser solo dígitos').required('El campo es requerido'),
  contractNumber: string().matches(/^[0-9]+$/, 'Deben ser solo dígitos').required('El campo es requerido'),
  ...
  transactionNumber: string().matches(/^[0-9]+$/, 'Deben ser solo dígitos').required('El campo es requerido'),
  ...
  dtbEmail: string().email('Email no es válido').required('El campo es requerido'),
  dtbIdentification: string().matches(/^[0-9]+$/, 'Deben ser solo dígitos').required('El campo es requerido'),
});

const { handleSubmit, values, errors, resetForm } = useForm<Latam.PaymentFormData>({
  initialValues: {
    fullname: '',
    identification: '',
    contractNumber: '',
